    ...
    <div class="container indexpage">
        ...
        <nav style="margin-bottom:20px;" class="navbar navbar-expand-lg navbar-light bg-light">
		    ...
		    <li  class="nav-item {!! (Request::is('stats') ? 'active' : '') !!}">
                    ...
                    <li style="display:none" class=" nav-item dropdown  {!! (Request::is('typography') || Request::is('advancedfeatures') || Request::is('grid') ? 'active' : '') !!}">
                    ...
                    <li style="display:none" class=" nav-item dropdown {!! (Request::is('aboutus') || Request::is('timeline') || Request::is('faq') || Request::is('blank_page')  ? 'active' : '') !!}">
                    ...
                    <li style="display:none" class="nav-item dropdown {!! (Request::is('products') || Request::is('single_product') || Request::is('compareproducts') || Request::is('category')  ? 'active' : '') !!}">
                    ...
                    <li style="display:none" class="nav-item dropdown {!! (Request::is('portfolio') || Request::is('portfolioitem') ? 'active' : '') !!}">
                ...
                @endif
                    <li style="display:none" class="nav-item {!! (Request::is(
                    ...
                    @if(Sentinel::guest())
                    <li style="display:none" class="nav-item"><a href="{{ URL::to('login') }}" class="nav-link">Login</a>
                    </li>
                    <li style="display:none" class="nav-item"><a href="{{ URL::to('register') }}" class="nav-link">Register</a>
                    </li>
                    @else
...
<div class=" col-12 copyright">
    <div class="container">
        <p>Copyright &copy; Verschu's family, 2019</p>
    </div>
</div>
</footer>
